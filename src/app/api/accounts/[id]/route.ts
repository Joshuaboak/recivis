  ...
  try {
    ...
    const [accountResult, contactsResult, assetsResult, invoicesResult] = await Promise.all([
      ...
      executeZohoTool('get_related_records', {
        ...
        parent_id: id,
        related_list: 'Assets',
        fields: 'Name,Product,Product_Code,Tag,Last_Renewal_Transaction,Status,Start_Date,Renewal_Date,Quantity,Serial_Key,Reseller,Upgraded_To_Key,Upgraded_From_Key,Renewal_Invoice_Generated,Not_Renewing_Asset,Revoked,Revoked_Reason,Evaluation_License,Educational_License,Record_Status__s',
      }),
      executeZohoTool('get_related_records', {
        parent_module: 'Accounts',
        parent_id: id,
